...
plot2_1 <- ggplot(data = trail_creek, aes(x = site, y = lc_excess, color = factor(date), group = date)) + 
  # reference line at 0
...
plot2_2 <- ggplot(data = coal_creek, aes(x = site, y = lc_excess, color = factor(date), group = date)) + 
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray", linewidth = 0.8) + 
...
plot2_3 <- ggplot(data = italian_creek, aes(x = site, y = lc_excess, color = factor(date), group = date)) + 
  # reference line at 0
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray", linewidth = 0.8) + 
  # adds a linear regression line for each date group
  geom_smooth(method = "lm", se = TRUE, linewidth = 1, alpha = 0.15) +
...
figure_2 <- plot2_1 + plot2_2 + plot2_3
...
figure_3 <- plot3_1 + plot3_2 + plot3_3
...
plot4_1 <- ggplot(delta_summary, aes(x = site, y = mean_lc, fill = site)) +
...
figure_4 <- plot4_1 + plot4_2 + plot4_3
...
plot5_1 <- ggplot(coal_creek, aes(x = delta_o, y = delta_d, color = site)) +
...
plot5_2 <- ggplot(italian_creek, aes(x = delta_o, y = delta_d, color = site)) +
  geom_point(alpha = 0.7, size = 2) +
...
plot5_3 <- ggplot(trail_creek, aes(x = delta_o, y = delta_d, color = site)) +
  geom_point(alpha = 0.7, size = 2) +
...
figure_5.0 <- plot5_1 + plot5_2 + plot5_3
figure_5.0
...
utc_discharge <- ggplot(discharge_utc_isco, aes(x = discharge, y = lc_excess)) +
  ...
  labs(title = "UTC-ISCO: Discharge vs. lc-excess",
       x = expression(paste("Discharge (cfs)")),
       y = "lc-excess (\u2030)") +
  theme_bw() +
  theme(plot.title = element_text(face = "bold", size = 14),
...
combined_stacked_4 <- tc_discharge / utc_discharge
...
ggplot(discharge_isco, aes(x = discharge,  y = lc_excess, 
  ...
  labs(title = "ISCO: Discharge vs. lc-excess",
       x = expression(paste("Discharge (cfs)")),
       y = "lc-excess (\u2030)") +
  theme_bw() +
  theme(plot.title = element_text(face = "bold", size = 14),
