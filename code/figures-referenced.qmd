...
ggplot(data = trail_creek, aes(x = site, y = lc_excess, color = date, group = date)) + 
  # reference line at 0
  ...
  labs(
    title = "Linear Trends of lc-excess across Sites by Date",
    subtitle = "Trends track changes from upstream to downstream factors",
...
ggplot(data = coal_creek, aes(x = site, y = lc_excess, color = date, group = date)) + 
  # reference line at 0
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray", linewidth = 0.8) + 
...
ggplot(data = italian_creek, aes(x = site, y = lc_excess, color = date, group = date)) + 
  # reference line at 0
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray", linewidth = 0.8) + 
